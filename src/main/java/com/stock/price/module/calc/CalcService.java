...
//	@Scheduled(cron = "0 15 10 15 * ?", zone = "Asia/Seoul")
	...
	public List<Stocks> getStockList() throws Exception {
		...
		String code = target.getCode() + ".1" + target.getMarket();
	...
	public static List<HistoricalQuote> getHistory(Stock stock, LocalDate from, LocalDate to, Interval interval) throws IOException{
